...
const styles = StyleSheet.create({
  ...
  sectionTitle: { color: '#111111', fontSize: 24, lineHeight: 30, fontWeight: '850', marginBottom: 10 },
  ...
  secondaryButtonText: { color: '#111111', fontSize: 15, fontWeight: '750' },
  buttonPressed: { opacity: 0.72 },
  buttonDisabled: { opacity: 0.48 },
  errorBox: { borderRadius: 16, borderWidth: 1, borderColor: '#FFD2CE', backgroundColor: '#FFF0EF', padding: 14, marginBottom: 14 },
  errorText: { color: '#B42318', fontSize: 15, lineHeight: 22, fontWeight: '650' },
