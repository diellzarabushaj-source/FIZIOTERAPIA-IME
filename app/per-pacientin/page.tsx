...
const steps = [
  { number: "01", icon: "key", title: "Merr kodin", text: "Fizioterapeuti ta dërgon kodin ose QR-në." },
  { number: "02", icon: "smartphone", title: "Hyr në plan", text: "Nuk ke nevojë të mësosh një program të vështirë." },
  { number: "03", icon: "video", title: "Shiko videon", text: "E sheh saktë si bëhet ushtrimi dhe sa herë duhet." },
  { number: "04", icon: "check", title: "Shëno që e bëre", text: "Pastaj vazhdon me ushtrimin tjetër." },
] as const;

const features = [
  { icon: "video", title: "Video të qarta", text: "Shiko ushtrimin sa herë që të duhet." },
  { icon: "calendar", title: "Kalendari yt", text: "E sheh cilat ditë i ke bërë ushtrimet." },
  { icon: "progress", title: "Përparimi", text: "Shiko sa ushtrime ke kryer dhe si po ecën." },
  { icon: "message", title: "Mesazhe", text: "Dërgo pyetje ose koment te fizioterapeuti." },
  { icon: "clock", title: "Kujtesa", text: "Merr njoftim kur është koha për ushtrimet." },
  { icon: "pain", title: "Dhimbja", text: "Shëno si je ndier pas ushtrimit." },
] as const;
      ...
      <section className="pp-hero">
        ...
        <div className="pp-phone-stage pp-reveal" aria-label="Pamje e planit të pacientit">
          ...
          <div className="pp-phone">
            ...
            <div className="pp-video"><UiIcon name="video" size={34} /></div>
            <div className="pp-progress"><span /></div>
            <button className="pp-complete" type="button"><UiIcon name="check" size={18} /> U krye</button>
          </div>
      ...
      <PageSection eyebrow="Para çdo seance" title="Si ndihesh sot?" text="Zgjidh përgjigjen që të përshtatet. Nëse je shumë më keq, fizioterapeuti njoftohet." tone="soft">
        <div className="pp-mood-card pp-reveal">
          ...
          <div className="pp-moods">
            <div className="pp-mood pp-mood-good"><strong>1</strong><small>Shumë mirë</small></div>
            <div className="pp-mood pp-mood-good"><strong>2</strong><small>Më mirë</small></div>
            <div className="pp-mood"><strong>3</strong><small>Njësoj</small></div>
            <div className="pp-mood pp-mood-warning"><strong>4</strong><small>Pak më keq</small></div>
            <div className="pp-mood pp-mood-danger"><strong>5</strong><small>Shumë më keq</small></div>
          </div>
        </div>
      </PageSection>
